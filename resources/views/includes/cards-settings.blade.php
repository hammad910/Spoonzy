    ...
    <div class="navbar-collapse collapse d-lg-block" id="navbarUserHome">
        ...
        <div class="card shadow-sm card-settings mb-3">
            <div class="list-group list-group-sm list-group-flush">
                ...
                <small
                    class="text-muted px-4 pt-3 text-uppercase mb-1 font-weight-bold">{{ __('general.faqs') }}</small>

                <a href="{{ url('settings/faqs') }}"
                    class="list-group-item list-group-item-action d-flex justify-content-between @if (request()->is('settings/faqs')) active @endif">
                    <div>
