...
@foreach ($mediaImageVideo as $media)
	...
	@endphp
		...
		@if ($media->type == 'image' || $media->type == 'video')
			...
			<a href="{{ $urlMedia . '?'. $isVaultFile }}" class="media-wrapper glightbox" data-gallery="gallery{{$msg->id}}" style="background-image: url('{{ $videoPoster ?? $urlMedia }}?w=960&h=980&{{ $isVaultFile }}')">
