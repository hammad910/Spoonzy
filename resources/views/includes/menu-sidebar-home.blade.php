<style>
    .menu-left-home li>a:not(.active),
    .menu-left-home li>a:not(.active) .span {
        font-weight: 400;
        font-size: 15px;
        color: #475467;
    }
    ...
    .menu-left-home li>a.active .span {
        font-weight: 600 !important;
        font-size: 15px !important;
        color: {{ $settings->theme_color_pwa ?? '#000000' }} !important
    }
    ...
    .menu-wrapper {
        ...
        height: 100%;
        /* sidebar ki height ke hisaab se */
    }
...
<div class="menu-wrapper">
    <ul class="list-unstyled d-lg-block d-none menu-left-home" style="padding-left: 15px; margin-top: 15px;">
        ...
        @if (($settings->allow_reels && auth()->user()?->getReelsActive()) || ($settings->allow_reels && auth()->guest()))
            <li>
                <a href="{{ url('reels') }}"
                    @if (auth()->guest() && $reelsPublic == 0) data-toggle="modal" data-target="#loginFormModal" @endif>
                    <svg xmlns="http://www.w3.org/2000/svg" class="align-text-bottom me-2" fill="currentColor"
                        width="19" height="19" viewBox="0 0 50 50">
                        <path
                    ...
                    <span class="ml-2 span">{{ __('general.reels') }}</span>
                </a>
            </li>
        @endif
