        ...
        <div class="container" style="background: #FBFBFB;">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="bi bi-eye-slash mr-2"></i>
                        {{ trans('general.block_countries') }}</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
                    ...
                    <form method="POST" action="{{ url('block/countries') }}">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <select name="countries[]" multiple class="form-control" id="select2Countries">
                                @foreach (Countries::orderBy('country_name', 'asc')->get() as $country)
                                    <option @if (in_array($country->country_code, auth()->user()->blockedCountries())) selected="selected" @endif
                        ...
                        <button class="btn btn-1 btn-block" style="color: white; background: {{ $settings->theme_color_pwa }}"
                            onClick="this.form.submit(); this.disabled=true; this.innerText='{{ trans('general.please_wait') }}';"
                            type="submit">{{ trans('general.save_changes') }}</button>
                    </form>
                </div><!-- end col-md-6 -->
            </div>
        </div>
