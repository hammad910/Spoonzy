...
<section class="section section-sm pb-0 h-100 section-msg">
    <div class="d-flex h-100" style="width: 100%;">
        ...
        {{-- Left: Menu Sidebar --}}
        <div class="d-none d-lg-block" style="height: 100vh; border-right: 1px solid #ddd; padding: 20px; width: 15%; flex-shrink: 0;">
            @include('includes.menu-sidebar-home')
        </div>

        {{-- Middle: Message Inbox Sidebar --}}
        <div class="wrapper-msg-inbox border-right" id="messagesContainer" style="width: 25%; height: 100vh; flex-shrink: 0; overflow-y: auto;">
        ...
        <div class="flex-grow-1 h-100" style="overflow-y: auto;">
            <div class="card w-100 rounded-0 h-100 border-top-0 border-0">
                ...
                <div class="content px-4 py-3 d-scrollbars container-msg h-100" id="contentDIV" data="{{$user->id}}">
                    @if ($messages->count() != 0)
