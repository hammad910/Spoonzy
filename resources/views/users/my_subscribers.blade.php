        ...
        <div class="container" style="background: #FBFBFB;">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="feather icon-users mr-2"></i> {{ __('users.my_subscribers') }}
                    </h2>
                                        ...
                                        @foreach ($subscriptions as $subscription)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <a href="{{ url($subscription->subscriber->username) }}"
                                                            class="mr-1">
                                                            <img src="{{ Helper::getFile(config('path.avatar') . $subscription->subscriber->avatar) }}"
