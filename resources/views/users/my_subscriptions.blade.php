        ...
        <div class="container" style="background: #FBFBFB;">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="feather icon-user-check mr-2"></i>
                        {{ __('users.my_subscriptions') }}</h2>
                ...
                <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
                                    ...
                                    <tbody>
                                        @foreach ($subscriptions as $subscription)
                                            <tr>
                                                ...
                                                <td>{{ $subscription->free == 'yes' ? __('general.not_applicable') : __('general.' . $subscription->interval) }}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @if (
                                                        ...
                                                        <span
                                                            class="badge badge-pill badge-success text-uppercase">{{ __('general.active') }}</span>
                                                        <br>
                                                    @elseif ($subscription->stripe_id != '' && $subscription->stripe_status == 'incomplete')
                                                        <span
                                                            class="badge badge-pill badge-warning text-uppercase">{{ __('general.incomplete') }}</span>
                                                        <br>
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge badge-pill badge-danger text-uppercase">{{ __('general.cancelled') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    @else
                        <div class="my-5 text-center">
                            ...
                            <h4 class="font-weight-light">{{ __('users.not_subscribed') }} <a href="{{ url('creators') }}"
                                    class="font-weight-900 link-border">{{ __('general.explore_creators') }}</a></h4>
                        </div>
                    @endif
