        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="bi bi-credit-card mr-2"></i> {{ __('users.payout_method') }}
                    </h2>
                    <p class="lead text-muted mt-0">{{ __('general.default_payout_method') }}:
                        ...
                        @else
                            <strong class="text-danger">{{ __('general.none') }}</strong>
                        @endif
                    </p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-lg-9 mb-5 mb-lg-0">
                    ...
                    @if (auth()->user()->verified_id != 'yes' && auth()->user()->balance == 0.0)
                        <div class="alert alert-danger mb-3">
                            <ul class="list-unstyled m-0">
                                <li><i class="fa fa-exclamation-triangle"></i> {{ __('general.verified_account_info') }} <a
                                        href="{{ url('settings/verify/account') }}"
                                        class="text-white link-border">{{ __('general.verify_account') }}</a></li>
                            </ul>
                        </div>
                    @endif
                    ...
                    @if (auth()->user()->verified_id == 'yes' || auth()->user()->balance != 0.0)
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            ...
                            <span> {{ __('general.payout_method_info') }}
                                <small class="btn-block">
                                    ...
                                    @else
                                        * {{ __('users.date_paid') }}
                                        {{ Helper::formatDate(Helper::paymentDateOfEachMonth($settings->specific_day_payment_withdrawals)) }}
                                    @endif
                                </small>
                            </span>
                        </div>
                        ...
                        @if ($settings->payout_method_paypal == 'on')
                            ...
                            <div class="custom-control custom-radio mb-3">
                                ...
                                <label class="custom-control-label" for="radio1">
                                    <span><img
                                            src="{{ url('public/img/payments', auth()->user()->dark_mode == 'off' ? 'paypal.png' : 'paypal-white.png') }}"
                                            width="70" /></span>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_paypal"
                                            ...
                                            placeholder="{{ __('general.email_paypal') }}" required type="email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_paypal_confirmation"
                                            placeholder="{{ __('general.confirm_email_paypal') }}" required type="email">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                                    type="submit">{{ __('general.save_payout_method') }}</button>
                            </form>
                            <!--============ END PAYPAL ============-->
                        @endif
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_payoneer"
                                            ...
                                            placeholder="{{ __('general.email_payoneer') }}" required type="email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_payoneer_confirmation"
                                            placeholder="{{ __('general.confirm_email_payoneer') }}" required
                                            type="email">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                        ...
                        @if ($settings->payout_method_zelle == 'on')
                            <!--============ START ZELLE ============-->
                            <div class="custom-control custom-radio mb-3 mt-3">
                                <input name="payment_gateway" value="Zelle" id="radio3" class="custom-control-input"
                                    @if (auth()->user()->payment_gateway == 'Zelle') checked @endif type="radio">
                            ...
                            <form method="POST" action="{{ url('settings/payout/method/zelle') }}" id="Zelle"
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_zelle"
                                            ...
                                            placeholder="{{ __('general.email_zelle') }}" required type="email">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="email_zelle_confirmation"
                                            placeholder="{{ __('general.confirm_email_zelle') }}" required
                                            type="email">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                        ...
                        @if ($settings->payout_method_western_union == 'on')
                            <!--============ START WESTERN ============-->
                            <div class="custom-control custom-radio mb-3 mt-3">
                                <input name="payment_gateway" value="Western" id="radioWestern"
                                    class="custom-control-input" @if (auth()->user()->payment_gateway == 'Western Union') checked @endif
                                    type="radio">
                                <label class="custom-control-label" for="radioWestern">
                                    <span><img src="{{ url('public/img/payments/western.png') }}"
                                            width="150" /></span>
                                    <small class="w-100 d-block">* {{ __('general.processor_fees_may_apply') }}</small>
                                </label>
                            </div>

                            <form method="POST" action="{{ url('settings/payout/method/western') }}" id="Western"
                                @if (auth()->user()->payment_gateway != 'Western Union') class="display-none" @endif>
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="name"
                                            value="{{ auth()->user()->document_id == '' ? old('name') : auth()->user()->name }}"
                                            placeholder="{{ __('auth.full_name') }}" required type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="document_id"
                                            value="{{ auth()->user()->document_id == '' ? old('document_id') : auth()->user()->document_id }}"
                                            placeholder="{{ __('general.document_id') }}" required type="text">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                                    type="submit">{{ __('general.save_payout_method') }}</button>
                        ...
                        @if ($settings->payout_method_crypto == 'on')
                            <!--============ START BITCOIN ============-->
                            <div class="custom-control custom-radio mb-3 mt-3">
                                <input name="payment_gateway" value="Bitcoin" id="BitcoinInput"
                                    class="custom-control-input" @if (auth()->user()->payment_gateway == 'Bitcoin') checked @endif
                                    type="radio">
                                <label class="custom-control-label" for="BitcoinInput">
                                    <span><img
                                            src="{{ url('public/img/payments', auth()->user()->dark_mode == 'off' ? 'bitcoin.png' : 'bitcoin-white.png') }}"
                                            width="100" /></span>
                                    <small class="w-100 d-block">* {{ __('general.processor_fees_may_apply') }}</small>
                                </label>
                            </div>

                            <form method="POST" action="{{ url('settings/payout/method/bitcoin') }}" id="Bitcoin"
                                @if (auth()->user()->payment_gateway != 'Bitcoin') class="display-none" @endif>
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="crypto_wallet"
                                            value="{{ auth()->user()->crypto_wallet == '' ? old('crypto_wallet') : auth()->user()->crypto_wallet }}"
                                            placeholder="{{ __('general.bitcoin_wallet') }}" required type="text">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                                    type="submit">{{ __('general.save_payout_method') }}</button>
                        ...
                        @if ($settings->payout_method_mercadopago == 'on')
                            <!--============ START WESTERN ============-->
                            <div class="custom-control custom-radio mb-3 mt-3">
                                <input name="payment_gateway" value="Mercadopago" id="radioMP"
                                    class="custom-control-input" @if (auth()->user()->payment_gateway == 'Mercado Pago') checked @endif
                                    type="radio">
                                <label class="custom-control-label" for="radioMP">
                                    <span><img
                                            src="{{ auth()->user()->dark_mode == 'off' ? url('public/img/payments/mercadopago.png') : url('public/img/payments/mercadopago-white.png') }}"
                                            width="150" /></span>
                                    <small class="w-100 d-block">* {{ __('general.only_payments_for_argentina') }}</small>
                                </label>
                            </div>

                            <form method="POST" action="{{ url('settings/payout/method/mercadopago') }}"
                                id="MercadoPago" @if (auth()->user()->payment_gateway != 'Mercado Pago') class="display-none" @endif>
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="alias_mp"
                                            value="{{ auth()->user()->alias_mp == '' ? old('alias_mp') : auth()->user()->alias_mp }}"
                                            placeholder="Alias MP" required type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        ...
                                        <input class="form-control" name="cvu"
                                            value="{{ auth()->user()->cvu == '' ? old('cvu') : auth()->user()->cvu }}"
                                            placeholder="Nro. CVU" required type="text">
                                    </div>
                                </div>
                                <button class="btn btn-1 btn-success btn-block"
                                    type="submit">{{ __('general.save_payout_method') }}</button>
                        ...
                        @if ($settings->payout_method_bank == 'on')
                            ...
                            <div class="custom-control custom-radio mb-3 mt-3">
                                ...
                                <label class="custom-control-label" for="radio4">
                                    <span><strong><i class="fa fa-university mr-1 icon-sm-radio"></i>
                                            {{ __('users.bank_transfer') }}</strong></span>
                                    <small class="w-100 d-block">* {{ __('general.processor_fees_may_apply') }}</small>
                                </label>
                            </div>
                            ...
                            <form method="POST" action="{{ url('settings/payout/method/bank') }}" id="Bank"
                                ...
                                <div class="form-group">
                                    <textarea name="bank_details" rows="5" cols="40" class="form-control" required
                                        placeholder="{{ __('users.bank_details') }}">{{ auth()->user()->bank == '' ? old('bank_details') : auth()->user()->bank }}</textarea>
                                </div>
                    ...
                    @if (auth()->user()->verified_id == 'yes' &&
                        ...
                        <h6 class="mt-5">Stripe Connect @if (auth()->user()->completed_stripe_onboarding)
                                <span
