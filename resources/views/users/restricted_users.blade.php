...
@section('title')
    {{ trans('general.restricted_users') }} -
@endsection
        ...
        <div class="container" style="background: #FBFBFB;">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="feather icon-slash mr-2"></i>
                        {{ trans('general.restricted_users') }}</h2>
                                    ...
                                    <tbody>
                                        @foreach ($restrictions as $restriction)
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <a href="{{ url($restriction->userRestricted()->username) }}">
                                                            <img src="{{ Helper::getFile(config('path.avatar') . $restriction->userRestricted()->avatar) }}"
                                                ...
                                                <td>
                                                    <button title=""
                                                        class="btn btn-danger btn-sm-custom removeRestriction"
